...
to provide custom formatting and logging for test results in the Saashq framework.
...
test results during test execution in the Saashq framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from saashq.deprecation_dumpster import SaashqDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=SaashqDeprecationWarning)
