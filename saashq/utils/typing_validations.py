...
from saashq.exceptions import SaashqTypeError
...
SaashqPydanticConfig = ConfigDict(arbitrary_types_allowed=True)
...
def TypeAdapter(type_):
	...
	return PyTypeAdapter(type_, config=SaashqPydanticConfig)
