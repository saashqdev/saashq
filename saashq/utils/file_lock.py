...
Use `saashq.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import saashq
from saashq.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in saashq.local.locked_documents:
		doc.unlock()
