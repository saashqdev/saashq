...
import saashq
from saashq.model.meta import get_field_currency, get_field_precision
...
def format_value(value, df=None, doc=None, currency=None, translated=False, format=None):
	...
	if not df:
		...
		default_currency = saashq.db.get_default("currency")
		...
		if isinstance(value, str):
			return saashq._(value, context=df.parent or "")
