...
import saashq
from saashq.website.page_renderers.error_page import ErrorPage
from saashq.website.page_renderers.not_found_page import NotFoundPage
from saashq.website.page_renderers.not_permitted_page import NotPermittedPage
...
def get_response(path=None, http_status_code=200) -> Response:
	...
	response = None
	path = path or saashq.local.request.path
	endpoint = path
