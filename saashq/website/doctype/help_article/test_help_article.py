...
class TestHelpArticle(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		cls.help_category = saashq.get_doc(
			{
		...
		cls.help_article = saashq.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from saashq.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		saashq.delete_doc(cls.help_article.doctype, cls.help_article.name)
		saashq.delete_doc(cls.help_category.doctype, cls.help_category.name)
