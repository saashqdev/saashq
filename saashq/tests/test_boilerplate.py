...
import saashq
from saashq.modules.patch_handler import get_all_patches, parse_as_configfile
from saashq.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		super().setUpClass()
		cls.default_hooks = saashq._dict(
			{
				"app_name": "test_app",
				"app_title": "Test App",
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(saashq.get_app_path("saashq", "patches.txt")))
		...
		expected_patch = "saashq.core.doctype.user.patches.delete_all_users"
