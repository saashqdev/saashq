...
class TestDocument(Document):
	def __init__(self, *args, **kwargs):
		...
		with patch("saashq.get_meta", return_value=create_mock_meta("TestDocument")):
...
class TestTracedDocument(TracedDocument):
	def __init__(self, *args, **kwargs):
		...
		with patch("saashq.get_meta", return_value=create_mock_meta("TestTracedDocument")):
			super().__init__(*args, **kwargs)
...
class TestTracedFieldContext(UnitTestCase):
	...
	def test_traced_field_context_not_in_test_mode(self):
		...
		# Temporarily set saashq.flags.in_test to False
		original_in_test = saashq.flags.in_test
		...
		try:
			...
			saashq.flags.in_test = original_in_test
