...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for Saashq tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to Saashq framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = saashq.get_module(cls.__module__)
	...
	# --- Saashq Framework specific assertions
...
def _get_doctype_from_module(cls):
	...
	path = saashq.get_pymodule_path(cls.__module__)
	try:
