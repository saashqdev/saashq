...
def get_remote_script(remote_site):
	...
	if request.status_code / 100 != 2:
		...
		click.secho(
			"Some errors occurred while recovering the migration script. Please contact us @ Saashq Cloud if this issue persists",
			fg="yellow",
		)
		return
...
def saashqcloud_migrator():
	remote_site_name = "saashqcloud.com"
