...
export default class Widget {
	...
	customize(options) {
		...
		options.allow_sorting &&
			saashq.utils.add_custom_button(
				saashq.utils.icon("es-line-drag", "xs"),
				null,
				"drag-handle",
				__("Drag"),
				null,
		...
		options.allow_edit &&
			saashq.utils.add_custom_button(
				saashq.utils.icon("es-line-edit-alt", "xs"),
				() => this.edit(),
				"edit-button",
				__("Edit"),
				null,
	...
	set_title(max_chars) {
		...
		let title = max_chars ? saashq.ellipsis(base, max_chars) : base;
