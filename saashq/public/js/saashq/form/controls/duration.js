saashq.ui.form.ControlDuration = class ControlDuration extends saashq.ui.form.ControlData {
	make_input() {
		super.make_input();
		this.make_picker();
	}
	...
	set_duration_options() {
		this.duration_options = saashq.utils.get_duration_options(this.df);
	}

	set_duration_picker_value(value) {
		let total_duration = saashq.utils.seconds_to_duration(value || 0, this.duration_options);
	...
	bind_events() {
		...
		this.$picker.on("change", ".duration-input", () => {
			...
			let value = saashq.utils.duration_to_seconds(
				duration.days,
				duration.hours,
				duration.minutes,
				duration.seconds
	...
	format_for_input(value) {
		return saashq.utils.get_formatted_duration(value, this.duration_options);
	}
