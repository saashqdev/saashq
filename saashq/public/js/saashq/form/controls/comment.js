...
saashq.ui.form.ControlComment = class ControlComment extends saashq.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${saashq.avatar(saashq.session.user, "avatar-medium")}
					<div class="saashq-control col"></div>
				</div>
		...
		`)
			: $('<div class="saashq-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to saashq-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".saashq-control")
