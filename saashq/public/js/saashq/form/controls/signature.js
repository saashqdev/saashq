saashq.ui.form.ControlSignature = class ControlSignature extends saashq.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		saashq.require("/assets/saashq/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${saashq.utils.icon("restriction", "md")}</i>
