...
window.validate_email = function (txt) {
	return saashq.utils.validate_type(txt, "email");
};

window.validate_phone = function (txt) {
	return saashq.utils.validate_type(txt, "phone");
};

window.validate_name = function (txt) {
	return saashq.utils.validate_type(txt, "name");
};

window.validate_url = function (txt) {
	return saashq.utils.validate_type(txt, "url");
};
