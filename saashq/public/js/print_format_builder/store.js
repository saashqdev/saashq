...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			saashq.model.clear_doc("Print Format", print_format_name);
			saashq.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = saashq.get_doc("Print Format", print_format_name);
				saashq.model.with_doctype(_print_format.doc_type, () => {
					meta.value = saashq.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return saashq.db.get_doc("Letter Head", _letterhead).then((doc) => {
