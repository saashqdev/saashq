...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from saashq.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = saashq.get_meta(self.document_type, cached=False).fields
