...
class FullTextSearch:
	...
	def create_index(self):
		saashq.create_folder(self.index_path)
	...
	def search(self, text: str, scope: str | None = None, limit: int = 20) -> list[saashq._dict]:
...
def get_index_path(index_name):
	return saashq.get_site_path("indexes", index_name)
