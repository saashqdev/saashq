...
from saashq.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from saashq.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from saashq.email.receive import Email
...
<div>
	...
	<img embed="assets/saashq/images/saashq-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/saashq/images/saashq-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = saashq.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="saashq-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/saashq/images/saashq-favicon.svg" alt="test" />
...
From: test1_@erpnexus.com
Reply-To: test2_@erpnexus.com
"""
			+ text_content_bytes
		)
