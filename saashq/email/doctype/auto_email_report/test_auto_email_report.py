...
from saashq.utils import add_to_date, get_link_to_form, today
from saashq.utils.data import is_html
...
class TestAutoEmailReport(IntegrationTestCase):
	def test_auto_email(self):
		saashq.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not saashq.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = saashq.get_doc(
		...
		auto_email_report = saashq.get_doc("Auto Email Report", "Permitted Documents For User")
