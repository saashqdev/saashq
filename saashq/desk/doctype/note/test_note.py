...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		saashq.db.delete("Version")
		saashq.db.delete("Note")
		saashq.db.delete("Note Seen By")

		return saashq.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = saashq.get_doc("Version", dict(docname=note.name))
