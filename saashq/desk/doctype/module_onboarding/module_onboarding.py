...
class ModuleOnboarding(Document):
	...
	if TYPE_CHECKING:
		from saashq.desk.doctype.onboarding_permission.onboarding_permission import OnboardingPermission
		from saashq.desk.doctype.onboarding_step_map.onboarding_step_map import OnboardingStepMap
	...
	def get_steps(self):
		return [saashq.get_doc("Onboarding Step", step.step) for step in self.steps]
	...
	def reset_progress(self):
		...
		saashq.msgprint(_("Module onboarding progress reset"), alert=True)
