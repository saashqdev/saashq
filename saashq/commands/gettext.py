...
from saashq.commands import pass_context
...
@click.option("--app", help="Only generate for this app. eg: saashq")
@pass_context
def generate_pot_file(context: CliCtxObj, app: str | None = None):
	from saashq.gettext.translate import generate_pot
...
@click.option("--app", help="Only compile for this app. eg: saashq")
@click.option(
	"--force",
	is_flag=True,
	default=False,
...
def compile_translations(context: CliCtxObj, app: str | None = None, locale: str | None = None, force=False):
	from saashq.gettext.translate import compile_translations as _compile_translations
...
@click.option("--app", help="Only migrate for this app. eg: saashq")
...
def csv_to_po(context: CliCtxObj, app: str | None = None, locale: str | None = None):
	from saashq.gettext.translate import migrate
...
@click.option("--app", help="Only update for this app. eg: saashq")
...
def update_po_files(context: CliCtxObj, app: str | None = None, locale: str | None = None):
	from saashq.gettext.translate import update_po
...
@click.option("--app", help="Only create for this app. eg: saashq")
@pass_context
def create_po_file(context: CliCtxObj, locale: str, app: str | None = None):
	"""Create PO file for lang code"""
	from saashq.gettext.translate import new_po
