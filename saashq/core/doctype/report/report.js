saashq.ui.form.on("Report", {
	refresh: function (frm) {
		if (frm.doc.is_standard === "Yes" && !saashq.boot.developer_mode) {
			...
			frm.add_custom_button(
				...
				function () {
					switch (doc.report_type) {
						case "Report Builder":
							saashq.set_route("List", doc.ref_doctype, "Report", doc.name);
							break;
						case "Query Report":
							saashq.set_route("query-report", doc.name);
							break;
						case "Script Report":
							saashq.set_route("query-report", doc.name);
							break;
