...
from saashq.utils import cint, convert_utc_to_system_timezone
from saashq.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> saashq._dict:
	...
	if current_job and not current_job.startswith(saashq.local.site):
		current_job = None
