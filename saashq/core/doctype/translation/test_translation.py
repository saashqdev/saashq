...
class TestTranslation(IntegrationTestCase):
	def setUp(self):
		saashq.db.delete("Translation")

	def tearDown(self):
		saashq.local.lang = "en"
		from saashq.translate import clear_cache
...
def create_translation(key, val):
	translation = saashq.new_doc("Translation")
