		...
		if communication.timeline_doctype and communication.timeline_name:
			...
			values.append(
				"""({}, "{}", "timeline_links", "Communication", "{}", "{}", "{}", "{}", "{}", "{}")""".format(
					counter,
					str(name),
					saashq.db.escape(communication.name),
					saashq.db.escape(communication.timeline_doctype),
					saashq.db.escape(communication.timeline_name),
		...
		if communication.link_doctype and communication.link_name:
			...
			values.append(
				"""({}, "{}", "timeline_links", "Communication", "{}", "{}", "{}", "{}", "{}", "{}")""".format(
					...
					str(name),
					saashq.db.escape(communication.name),
					saashq.db.escape(communication.link_doctype),
					saashq.db.escape(communication.link_name),
					communication.creation,
					communication.modified,
					communication.modified_by,
				)
