context("Workspace Blocks", () => {
	...
	it("Create Test Page", () => {
		cy.intercept({
			method: "POST",
			url: "api/method/saashq.desk.doctype.workspace.workspace.new_page",
		}).as("new_page");
	...
	it.skip("Quick List Block", () => {
		...
		cy.intercept({
			method: "GET",
			url: "api/method/saashq.desk.form.load.getdoctype?**",
		}).as("get_doctype");
		...
		cy.intercept({
			method: "POST",
			url: "api/method/saashq.desk.reportview.get",
		}).as("refresh-list");
