context("Control Select", () => {
	...
	it("toggles placholder on clicking an option", () => {
		...
		cy.get(".saashq-control[data-fieldname=select_control] .control-input").as("control");
		cy.get(".saashq-control[data-fieldname=select_control] .control-input select").as(
			"select"
		);
