...
// 		cy.window().its('saashq').then(saashq => {
// 			saashq.call("saashq.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/saashq.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/saashq.model.utils.user_settings.save')
